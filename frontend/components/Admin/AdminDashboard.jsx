...
export default function AdminDashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F5F0', padding: '2rem 1rem' }}>
      {/* Header */}
      <header style={{ maxWidth: 1100, margin: '0 auto 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 20, color: '#1A3C5E' }}>MedBook</span>
          <span style={{ fontSize: 13, color: '#9A8F82', marginLeft: 4 }}>/ Admin</span>
        </div>
        <Link
          href="/book"
          style={{
            fontSize: 13, color: 'white', textDecoration: 'none', fontWeight: 500,
            background: '#2E8B7A', padding: '6px 14px', borderRadius: 7,
          }}
        >
          + New Booking
        </Link>
